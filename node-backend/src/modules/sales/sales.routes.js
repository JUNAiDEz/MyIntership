...
router.post('/promotions', verifyToken, checkRole(['Admin', 'Manager']), promotionsController.createPromotion);
router.put('/promotions/:id', verifyToken, checkRole(['Admin', 'Manager']), promotionsController.updatePromotion);
router.delete('/promotions/:id', verifyToken, checkRole(['Admin', 'Manager']), promotionsController.deletePromotion);
router.patch('/promotions/:id/toggle_status', verifyToken, checkRole(['Admin', 'Manager']), promotionsController.togglePromotionStatus);
