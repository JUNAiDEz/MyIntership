...
// ✅ แก้ไข Path ถอยหลัง 1 โฟลเดอร์เพื่อเรียกใช้ usePermissions
import { usePermissions } from '../utils/usePermissions'; 

// ⚠️ สำคัญมาก: หากไฟล์ CSS ของคุณไม่ได้อยู่ในโฟลเดอร์ components คุณต้องเปลี่ยน Path ตรงนี้
// เช่น ถ้า Dashboard.module.css อยู่ในโฟลเดอร์ pages ให้เปลี่ยนเป็น '../pages/Dashboard.module.css' (ปรับตามโครงสร้างจริง)
