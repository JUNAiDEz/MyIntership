...
// Simple theme switch component converted from provided HTML
// - toggles a `dark-theme` class on document.documentElement
// - uses the same class names as the original snippet so existing CSS can apply
function ThemeSwitch() {
  const [checked, setChecked] = useState(false);

  useEffect(() => {
    // Initialize from previously saved preference (if any)
    try {
  ...
  return (
    <label className={`${styles['theme-switch']} ${styles.compact}`} aria-label="Toggle theme">
      <input
        type="checkbox"
