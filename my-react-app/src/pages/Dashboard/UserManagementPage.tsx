                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 }}>
                            ...
                            {editingUserPermissions ? (
                                <div style={{display:'flex', gap:10}}>
                                    ...
                                    <button onClick={handleSaveUserPermissions} className={styles.btnSubmit} disabled={saveUserPermissionsMutation.isPending}>Save</button>
                                </div>
                            ) : (
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 }}>
                            ...
                            {editingPermissions ? (
                                <div style={{display:'flex', gap:10}}>
                                    ...
                                    <button onClick={handleSavePermissions} className={styles.btnSubmit} disabled={savePermissionsMutation.isPending}>Save</button>
                                </div>
                            ) : (
                ...
                {modal.mode === 'view' ? (
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className={styles.modalActions}>
                            ...
                            <button type="submit" className={styles.btnSubmit} disabled={saveMutation.isPending}>Save</button>
                        </div>
                    </form>
                )}
            </div>
            ...
            <div className={styles.modalContent}>
                ...
                <form onSubmit={handleCreatePermission}>
                    ...
                    <div className={styles.modalActions}>
                        ...
                        <button type="submit" className={styles.btnSubmit} disabled={createPermissionMutation.isPending}>Create</button>
                    </div>
                </form>
            </div>
        </div>
