...
function ServiceCard({ title, desc, icon, link, colorClass }) {
  return (
...
const FitmentCard = (props) => <ServiceCard {...props} colorClass="cardOrange" />;
const MaintenanceCard = (props) => <ServiceCard {...props} colorClass="cardGreen" />;
const UpgradeCard = (props) => <ServiceCard {...props} colorClass="cardRed" />;
const WrapCarCard = (props) => <ServiceCard {...props} colorClass="cardPurple" />;

// Widget Card Component for Home
const HomeWidget = ({ title, count, icon, color, subtext }) => (
...
// Quick Action Card
const QuickLink = ({ to, title, icon, color }) => (
