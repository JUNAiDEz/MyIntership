// src/pages/Dashboard/FitmentManagement/AlignmentManagementPage.jsx
...
export default function AlignmentManagementPage({ onLogout }) {
  // --- State ---
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const serviceRes = await api.apiGet('/api/services?search=Alignment');
      const service = (serviceRes && serviceRes.length > 0) ? serviceRes[0] : null;
      if (!service) {
        alert('ไม่พบบริการ Alignment ในระบบ');
        return;
      }
      const body = {
