// src/pages/Dashboard/FitmentManagement/BallJointsManagementPage.jsx
...
export default function BallJointsManagementPage({ onLogout }) {
  // --- State ---
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const serviceRes = await api.apiGet('/api/services?search=Ball Joints');
      const service = (serviceRes && serviceRes.length > 0) ? serviceRes[0] : null;
      if (!service) {
        alert('ไม่พบบริการ Ball Joints ในระบบ');
        return;
      }
      const body = {
