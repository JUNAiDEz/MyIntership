...
export default function DealerManagementPage({ onLogout }) {
  ...
  // --- Modal & Form State ---
  const [modal, setModal] = useState({ open: false, mode: 'view', dealer: null });
  ...
  const fetchDealers = useCallback(async () => {
    ...
    try {
      ...
      const sortedData = (Array.isArray(result) ? result : result.data || []).sort((a, b) => a.display_order - b.display_order);
  ...
  const handleImageUpload = async (file) => {
    ...
    try {
      ...
      setCreateForm(prev => ({ ...prev, image_url: base64 }));
    } catch (err) {
      console.error(err);
              ...
              <div style={{ padding: '25px', overflowY: 'auto', flex: 1 }}>
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className={styles.formGroup} style={{ marginBottom: '20px' }}>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
                          <label style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: '#ffc709', color: '#000', padding: '8px 16px', borderRadius: '6px', cursor: 'pointer', fontSize: '0.9rem', fontWeight: 'bold' }}>
                              ...
                              <input type="file" accept="image/*" onChange={e => handleImageUpload(e.target.files[0])} disabled={uploadingImage} style={{ display: 'none' }} />
                          </label>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '10px', borderTop: '1px solid #eee', paddingTop: '15px', marginTop: '10px' }}>
                      ...
                      <button type="submit" disabled={createLoading || uploadingImage} style={{ padding: '8px 25px', borderRadius: '6px', border: 'none', background: '#000', color: '#fff', cursor: 'pointer', fontWeight: 'bold' }}>
