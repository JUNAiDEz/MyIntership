...
import styles from './BallJoints.module.css'; // เปลี่ยน import
      ...
      <main className={styles.mainContent}>
        ...
        <section className={styles.heroSection}>
          <div className={styles.heroMainBanner}>
            ...
            <div className={styles.heroOverlayContent}>
              <h1 className={styles.heroTitle}>บริการลูกหมาก</h1>
              <p className={styles.heroDescription}>
                บริการตรวจเช็คและเปลี่ยนลูกหมาก 
                รักษาความปลอดภัยและการควบคุมรถให้อยู่ในสภาพสมบูรณ์
              </p>
        ...
        <section className={`${styles.ourServicesSection} container`}>
          <div className={styles.sectionHeader}>
            <h2 className={styles.sectionTitle}>บริการเกี่ยวกับลูกหมาก</h2>
            <div className={styles.carouselControls}>
              <button>&lt;</button>
              <button>&gt;</button>
            </div>
          ...
          <div className={styles.servicesGrid}>
            <div className={styles.serviceCard}>
              ...
              <h3>ลูกหมากปีกนก</h3>
              <p>เปลี่ยนลูกหมากปีกนก (บน / ล่าง)</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>ลูกหมากคันชัก</h3>
              <p>เปลี่ยนลูกหมากคันชัก (ตัวนอก / ตัวใน)</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>ลูกหมากกันโคลง</h3>
              <p>เปลี่ยนลูกหมากกันโคลง (หน้า / หลัง)</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>ลูกหมากแร็ค</h3>
              <p>เปลี่ยนลูกหมากปลายแร็คพวงมาลัย</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>เปลี่ยนบูชปีกนก</h3>
              <p>อัด / เปลี่ยน บูชปีกนก แก้ปัญหารถร่อน</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>เช็คช่วงล่าง</h3>
              <p>ตรวจเช็คระบบช่วงล่างทั้งหมด ฟรี!</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
          </div>
        </section>
