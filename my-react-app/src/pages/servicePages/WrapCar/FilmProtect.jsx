...
import styles from './FilmProtect.module.css'; // เปลี่ยน import
      ...
      <main className={styles.mainContent}>
        ...
        <section className={styles.heroSection}>
          <div className={styles.heroMainBanner}>
            ...
            <div className={styles.heroOverlayContent}>
              <h1 className={styles.heroTitle}>ฟิลม์สีกันรอย</h1>
              <p className={styles.heroDescription}>
                บริการติดตั้งฟิล์มสีกันรอยคุณภาพ 
                ช่วยปกป้องสีรถจากริ้วรอยและหินกระเด็น
              </p>
        ...
        <section className={`${styles.ourServicesSection} container`}>
          <div className={styles.sectionHeader}>
            <h2 className={styles.sectionTitle}>บริการเกี่ยวกับฟิล์ม</h2>
            <div className={styles.carouselControls}>
              <button>&lt;</button>
              <button>&gt;</button>
            </div>
          ...
          <div className={styles.servicesGrid}>
            <div className={styles.serviceCard}>
              ...
              <h3>ติดตั้งฟิล์มใส (PPF)</h3>
              <p>ติดตั้งฟิล์มใสกันรอย (Paint Protection Film)</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>ติดตั้งฟิล์มสี</h3>
              <p>บริการแร็ปฟิล์มสี (Color Wrap)</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>ฟิล์มไฟหน้า/ไฟท้าย</h3>
              <p>ติดตั้งฟิล์มกันรอยไฟหน้า-ไฟท้าย</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>ฟิล์มภายใน</h3>
              <p>ติดตั้งฟิล์มกันรอยภายใน (Piano Black)</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>ลอกฟิล์ม</h3>
              <p>บริการลอกฟิล์มเก่า คราบกาว</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>เคลือบเซรามิกทับ</h3>
              <p>เคลือบเซรามิกทับฟิล์ม (Top Coat)</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
          </div>
        </section>
