...
import styles from './Exhaust.module.css'; // เปลี่ยน import
        ...
        <section className={styles.heroSection}>
          <div className={styles.heroMainBanner}>
            ...
            <div className={styles.heroOverlayContent}>
              <h1 className={styles.heroTitle}>บริการท่อไอเสีย</h1>
              <p className={styles.heroDescription}>
                จำหน่ายและติดตั้งท่อไอเสียคุณภาพ 
                ปรับเสียงและสมรรถนะตามความต้องการ
              </p>
