...
import styles from './BoostGauge.module.css'; // เปลี่ยน import
      ...
      <main className={styles.mainContent}>
        ...
        <section className={styles.heroSection}>
          <div className={styles.heroMainBanner}>
            ...
            <div className={styles.heroOverlayContent}>
              <h1 className={styles.heroTitle}>บริการวัดบูส</h1>
              <p className={styles.heroDescription}>
                ติดตั้งและปรับตั้งเครื่องมือวัดบูส (Boost Gauge) 
                เพื่อเช็คและปรับแต่งระบบอัดอากาศ (Turbo)
              </p>
        ...
        <section className={`${styles.ourServicesSection} container`}>
          <div className={styles.sectionHeader}>
            <h2 className={styles.sectionTitle}>บริการเกี่ยวกับเกจวัด</h2>
            <div className={styles.carouselControls}>
              <button>&lt;</button>
              <button>&gt;</button>
            </div>
          ...
          <div className={styles.servicesGrid}>
            <div className={styles.serviceCard}>
              ...
              <h3>ติดตั้งวัดบูส</h3>
              <p>ติดตั้งเกจวัดบูส (Analog / Digital)</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>ติดตั้งเกจชุด</h3>
              <p>ติดตั้งเกจวัดชุด (Water Temp, Oil Temp, Volt)</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>เช็คบูสรั่ว</h3>
              <p>ตรวจเช็คระบบท่ออินเตอร์ฯ หาจุดรั่วซึม</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>ย้ายตำแหน่งเกจ</h3>
              <p>บริการย้ายตำแหน่งติดตั้งเกจวัดต่างๆ</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>ติดตั้ง ZD / OBD2</h3>
              <p>ติดตั้งเกจวัดแบบ ZD หรือเกจผ่าน OBD2</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>ปรับบูสต์</h3>
              <p>บริการติดตั้งและปรับตั้งบูสต์มือ / บูสต์ไฟฟ้า</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
          </div>
        </section>
