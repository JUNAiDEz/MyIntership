...
import styles from './Nano.module.css'; // เปลี่ยน import
      ...
      <main className={styles.mainContent}>
        ...
        <section className={styles.heroSection}>
          <div className={styles.heroMainBanner}>
            ...
            <div className={styles.heroOverlayContent}>
              <h1 className={styles.heroTitle}>Nano Coating</h1>
              <p className={styles.heroDescription}>
                เคลือบแก้ว Nano ปกป้องผิวสี 
                ลดคราบน้ำและรอยขีดข่วนเล็กๆ
              </p>
        ...
        <section className={`${styles.ourServicesSection} container`}>
          <div className={styles.sectionHeader}>
            <h2 className={styles.sectionTitle}>บริการเคลือบแก้ว / เคลือบเซรามิก</h2>
            <div className={styles.carouselControls}>
              <button>&lt;</button>
              <button>&gt;</button>
            </div>
          ...
          <div className={styles.servicesGrid}>
            <div className={styles.serviceCard}>
              ...
              <h3>เตรียมผิว (Preparation)</h3>
              <p>ขัดลบรอย ขจัดคราบไคล ก่อนการเคลือบ</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>เคลือบแก้ว (Nano)</h3>
              <p>เคลือบแก้ว ให้ความเงางาม ปกป้องผิวสี</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>เคลือบเซรามิก (Ceramic)</h3>
              <p>เคลือบเซรามิก ทนทานสูง ลดการเกาะของน้ำ</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>เคลือบกระจก</h3>
              <p>เคลือบกระจก (Glass Coating) น้ำไม่เกาะ</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>เคลือบล้อแม็กซ์</h3>
              <p>เคลือบล้อแม็กซ์ (Wheel Coating) กันฝุ่นเบรก</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>บำรุงรักษา (Maintenance)</h3>
              <p>บริการดูแล เติมชั้นเคลือบ (Top Coat) ประจำปี</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
          </div>
        </section>
