...
const pricingData = [
  {
    brand: "TOYOTA",
    models: [
      { name: "VIOS / YARIS", img: "https://images.unsplash.com/photo-1621503940178-62024220cc33?q=80&w=600&auto=format&fit=crop", price: "450.- / 650.-", stage: "Small / Large", note: "สำหรับเครื่องยนต์ปกติ, Small: 450.-, Large: 650.-" },
      { name: "ALTIS", img: "https://images.unsplash.com/photo-1619767886558-efdc259cde1a?q=80&w=600&auto=format&fit=crop", price: "450.- / 650.-", stage: "Small / Large", note: "สำหรับเครื่องยนต์ปกติ, Small: 450.-, Large: 650.-" },
      { name: "CAMRY", img: "https://images.unsplash.com/photo-1621007947382-bb3c3968e3bb?q=80&w=600&auto=format&fit=crop", price: "550.- / 850.-", stage: "Small / Large", note: "เครื่องยนต์ใหญ่, Small: 550.-, Large: 850.-" },
      { name: "REVO / FORTUNER", img: "https://images.unsplash.com/photo-1533473359331-0135ef1b58bf?q=80&w=600&auto=format&fit=crop", price: "550.- / 850.-", stage: "Small / Large", note: "ดีเซล/เบนซิน, Small: 550.-, Large: 850.-" },
    ]
  },
  {
    brand: "HONDA",
    models: [
      { name: "JAZZ / CITY", img: "https://images.unsplash.com/photo-1568844293986-8d0400bd4745?q=80&w=600&auto=format&fit=crop", price: "450.- / 650.-", stage: "Small / Large", note: "เครื่องยนต์เล็ก-กลาง, Small: 450.-, Large: 650.-" },
      { name: "CIVIC", img: "https://images.unsplash.com/photo-1605816922336-6c703b44c602?q=80&w=600&auto=format&fit=crop", price: "500.- / 750.-", stage: "Small / Large", note: "Turbo/Non-Turbo, Small: 500.-, Large: 750.-" },
    ]
  },
  {
    brand: "ISUZU",
    models: [
      { name: "D-MAX", img: "https://images.unsplash.com/photo-1552519507-da3b142c6e3d?q=80&w=600&auto=format&fit=crop", price: "550.- / 850.-", stage: "Small / Large", note: "ดีเซล, Small: 550.-, Large: 850.-" },
      { name: "MU-X", img: "https://images.unsplash.com/photo-1549399542-7e3f8b79c341?q=80&w=600&auto=format&fit=crop", price: "600.- / 900.-", stage: "Small / Large", note: "Small: 600.-, Large: 900.-" },
    ]
  }
];
...
function Perfume({ onLogout }: { onLogout?: () => void }) {
  ...
  const pageUrl = typeof window !== 'undefined' ? window.location.href : 'https://front.gt7dev.com/services/product/perfume';
  const title = 'Car Perfume — น้ำหอมรถยนต์';
  const description = 'บริการน้ำหอมรถยนต์และดูแลกลิ่นหอมภายในรถยนต์ระดับพรีเมียม';
