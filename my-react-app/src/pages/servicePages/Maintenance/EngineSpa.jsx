      ...
      <main className={styles.mainContent}>
        ...
        <section className={styles.heroSection}>
          <div className={styles.heroMainBanner}>
            ...
            <div className={styles.heroOverlayContent}>
              <h1 className={styles.heroTitle}>บริการสปาเครื่องยนต์<br/>(Engine Spa)</h1>
              <p className={styles.heroDescription}>
                คืนความใหม่ให้ห้องเครื่องของคุณ ด้วยบริการสปาเครื่องยนต์ 
                ทำความสะอาดคราบน้ำมัน ฝุ่นสะสมอย่างปลอดภัย
              </p>
        ...
        <section className={`${styles.ourServicesSection} container`}>
          <div className={styles.sectionHeader}>
            <h2 className={styles.sectionTitle}>บริการสปาเครื่องยนต์</h2>
            <div className={styles.carouselControls}>
              <button>&lt;</button>
              <button>&gt;</button>
            </div>
          ...
          <div className={styles.servicesGrid}>
            <div className={styles.serviceCard}>
              ...
              <h3>ล้างห้องเครื่อง (แห้ง)</h3>
              <p>ทำความสะอาดแบบแห้ง ปลอดภัยต่อระบบไฟ</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>ล้างห้องเครื่อง (เปียก)</h3>
              <p>ล้างด้วยน้ำยาเฉพาะทาง ขจัดคราบหนัก</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>ขจัดคราบน้ำมัน</h3>
              <p>ขจัดคราบน้ำมันเครื่อง จาระบี ที่รั่วซึม</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>เคลือบห้องเครื่อง</h3>
              <p>เคลือบเงาพลาสติก ท่อยาง ให้ดูใหม่</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>ขัดสนิม / คราบขาว</h3>
              <p>ขัดทำความสะอาดคราบสนิม คราบตะกรัน</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>แพ็คเกจสปา</h3>
              <p>บริการทำความสะอาดครบวงจรทั้งภายใน</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
          </div>
        </section>
