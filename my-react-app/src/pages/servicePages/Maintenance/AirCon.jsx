...
// ไม่ได้ใช้ ProductCarousel แล้ว
// import ProductCarousel from '../../components/Product/ProductCarousel';

// --- Component หลักของหน้า ---
function AirCon({ onLogout }) {
      ...
      <main className={styles.mainContent}>
        ...
        <section className={styles.heroSection}>
          <div className={styles.heroMainBanner}>
            ...
            <div className={styles.heroOverlayContent}>
              <h1 className={styles.heroTitle}>บริการล้างแอร์<br/>(Air-Con Cleaning)</h1>
              <p className={styles.heroDescription}>
                อากาศสะอาด หายใจสดชื่น ด้วยบริการล้างแอร์แบบมืออาชีพ 
                ขจัดฝุ่น สิ่งสกปรก และเชื้อโรคสะสม
              </p>
        ...
        <section className={`${styles.ourServicesSection} container`}>
          <div className={styles.sectionHeader}>
            <h2 className={styles.sectionTitle}>บริการเกี่ยวกับระบบแอร์</h2>
            <div className={styles.carouselControls}>
              <button>&lt;</button>
              <button>&gt;</button>
            </div>
          ...
          <div className={styles.servicesGrid}>
            <div className={styles.serviceCard}>
              ...
              <h3>ล้างแอร์ (ไม่ถอดตู้)</h3>
              <p>ล้างทำความสะอาดแผงคอยล์เย็นด้วยกล้อง</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>ล้างแอร์ (ถอดตู้)</h3>
              <p>ล้างใหญ่ ถอดคอนโซลหน้า ล้างตู้แอร์</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>เติมน้ำยาแอร์</h3>
              <p>ตรวจเช็คและเติมน้ำยาแอร์ R134a, R1234yf</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>ซ่อมระบบแอร์</h3>
              <p>ซ่อมคอมแอร์, แผงคอยล์ร้อน, วาล์วแอร์</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>เปลี่ยนกรองแอร์</h3>
              <p>เปลี่ยนไส้กรองอากาศแอร์ (Cabin Filter)</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>อบโอโซน</h3>
              <p>บริการอบโอโซน ฆ่าเชื้อโรคและกลิ่นอับ</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
          </div>
        </section>
