...
import styles from './TurboInter.module.css'; // เปลี่ยน import
      ...
      <main className={styles.mainContent}>
        ...
        <section className={styles.heroSection}>
          <div className={styles.heroMainBanner}>
            ...
            <div className={styles.heroOverlayContent}>
              <h1 className={styles.heroTitle}>บริการติดตั้งเทอร์โบ <br/> อินเตอร์คูลเลอร์</h1>
              <p className={styles.heroDescription}>
                บริการติดตั้งเทอร์โบและอินเตอร์คูลเลอร์คุณภาพสูง 
                เพิ่มกำลังอัด เพิ่มแรงม้า พร้อมระบบระบายความร้อนที่มีประสิทธิภาพ
              </p>
        ...
        <section className={`${styles.ourServicesSection} container`}>
          <div className={styles.sectionHeader}>
            <h2 className={styles.sectionTitle}>บริการเกี่ยวกับเทอร์โบ</h2>
            <div className={styles.carouselControls}>
              <button>&lt;</button>
              <button>&gt;</button>
            </div>
          ...
          <div className={styles.servicesGrid}>
            <div className={styles.serviceCard}>
              ...
              <h3>ติดตั้งเทอร์โบ</h3>
              <p>บริการติดตั้งเทอร์โบ (Turbocharger) ทุกรุ่น</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>ติดตั้งอินเตอร์ฯ</h3>
              <p>ติดตั้งอินเตอร์คูลเลอร์ (Intercooler) ระบายความร้อน</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>อัพเกรดเทอร์โบ</h3>
              <p>อัพเกรดเทอร์โบให้ใหญ่ขึ้น รองรับบูสต์สูง</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>ซ่อมเทอร์โบ</h3>
              <p>บริการซ่อมเทอร์โบ รั่ว ซึม แกนขาด</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>เดินท่ออินเตอร์ฯ</h3>
              <p>บริการเดินท่ออินเตอร์คูลเลอร์ อลูมิเนียม/ไทเทเนียม</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>จูนอัพ / Remap</h3>
              <p>จูนกล่องหลัก (Remap) หลังติดตั้งเทอร์โบ</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
          </div>
        </section>
