...
import styles from './RemoteControl.module.css'; // เปลี่ยน import
...
function RemoteControl({ onLogout }) {
      ...
      <main className={styles.mainContent}>
        ...
        <section className={styles.heroSection}>
          <div className={styles.heroMainBanner}>
            ...
            <div className={styles.heroOverlayContent}>
              <h1 className={styles.heroTitle}>บริการติดตั้งรีโมท<br/>ควบคุมระยะไกล</h1>
              <p className={styles.heroDescription}>
                บริการติดตั้งระบบรีโมทควบคุมระยะไกลสำหรับรถยนต์ 
                ควบคุมการทำงานของเครื่องยนต์และระบบต่างๆ ผ่านรีโมท 
        ...
        <section className={`${styles.ourServicesSection} container`}>
          <div className={styles.sectionHeader}>
            <h2 className={styles.sectionTitle}>บริการเกี่ยวกับระบบรีโมท</h2>
            <div className={styles.carouselControls}>
              <button>&lt;</button>
              <button>&gt;</button>
            </div>
          ...
          <div className={styles.servicesGrid}>
            <div className={styles.serviceCard}>
              ...
              <h3>ติดตั้งรีโมทสตาร์ท</h3>
              <p>สตาร์ทเครื่องยนต์ เปิดแอร์ ผ่านรีโมท</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>ระบบ Keyless Entry</h3>
              <p>ติดตั้งระบบ Smart Key / Push Start</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>รีโมทกันขโมย</h3>
              <p>ติดตั้งระบบกันขโมย พร้อมรีโมทควบคุม</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>ควบคุมผ่านมือถือ</h3>
              <p>ติดตั้งระบบควบคุมรถผ่าน Application มือถือ</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>ซ่อม/ก๊อปปี้รีโมท</h3>
              <p>บริการซ่อมรีโมท ก๊อปปี้รีโมท ทำกุญแจฝังชิพ</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>อัพเกรดระบบ</h3>
              <p>อัพเกรดระบบรีโมทเดิม ให้มีฟังก์ชั่นมากขึ้น</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
          </div>
        </section>
