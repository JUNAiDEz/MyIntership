...
import styles from './CustomExhaust.module.css'; // เปลี่ยน import
...
function CustomExhaust({ onLogout }) {
      ...
      <main className={styles.mainContent}>
        ...
        <section className={styles.heroSection}>
          <div className={styles.heroMainBanner}>
            ...
            <div className={styles.heroOverlayContent}>
              <h1 className={styles.heroTitle}>บริการติดตั้งท่อไอเสียแต่ง</h1>
              <p className={styles.heroDescription}>
                บริการติดตั้งท่อไอเสียแต่งคุณภาพสูง เสียงนุ่มลึก 
                เพิ่มประสิทธิภาพการระบายไอเสีย ช่วยให้เครื่องยนต์หายใจได้ดีขึ้น
              </p>
        ...
        <section className={`${styles.ourServicesSection} container`}>
          <div className={styles.sectionHeader}>
            <h2 className={styles.sectionTitle}>บริการเกี่ยวกับท่อไอเสีย</h2>
            <div className={styles.carouselControls}>
              <button>&lt;</button>
              <button>&gt;</button>
            </div>
          ...
          <div className={styles.servicesGrid}>
            <div className={styles.serviceCard}>
              ...
              <h3>เดินท่อสแตนเลส</h3>
              <p>บริการเดินท่อไอเสียสแตนเลส / ไทเทเนียม</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>ติดตั้งหม้อพัก</h3>
              <p>เปลี่ยนหม้อพัก (Muffler) สูตรตรง สูตรวน</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>ติดตั้ง Downpipe</h3>
              <p>ติดตั้ง Downpipe / Front pipe (ท่อแทนแคท)</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>ติดตั้ง Header</h3>
              <p>ติดตั้งเฮดเดอร์ (Exhaust Manifold)</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>เปลี่ยนปลายท่อ</h3>
              <p>เปลี่ยนปลายท่อไอเสีย คาร์บอน / ไทเทเนียม</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>ซ่อมท่อไอเสีย</h3>
              <p>บริการซ่อมแซมท่อไอเสียรั่ว แตก</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
          </div>
        </section>
