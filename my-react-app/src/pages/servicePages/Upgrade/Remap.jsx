...
import styles from './Remap.module.css'; // เปลี่ยน import
      ...
      <main className={styles.mainContent}>
        ...
        <section className={styles.heroSection}>
          <div className={styles.heroMainBanner}>
            ...
            <div className={styles.heroOverlayContent}>
              <h1 className={styles.heroTitle}>บริการรีแมพ ECU</h1>
              <p className={styles.heroDescription}>
                บริการปรับแต่งการทำงานของ ECU เพื่อเพิ่มสมรรถนะของเครื่องยนต์
                ให้มีกำลังเพิ่มขึ้น ประหยัดน้ำมัน และตอบสนองได้ดียิ่งขึ้น
              </p>
        ...
        <section className={`${styles.ourServicesSection} container`}>
          <div className={styles.sectionHeader}>
            <h2 className={styles.sectionTitle}>บริการรีแมพ / จูนกล่อง</h2>
            <div className={styles.carouselControls}>
              <button>&lt;</button>
              <button>&gt;</button>
            </div>
          ...
          <div className={styles.servicesGrid}>
            <div className={styles.serviceCard}>
              ...
              <h3>รีแมพ (Remap)</h3>
              <p>จูนกล่องหลัก เพิ่มแรงม้า/แรงบิด (Stage 1-2)</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>อุด EGR</h3>
              <p>บริการอุด EGR (Software / Hardware)</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>ลบ DPF</h3>
              <p>บริการลบ DPF (Software / Hardware)</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>ปลดล็อคความเร็ว</h3>
              <p>ปลดล็อคความเร็วปลาย (Speed Limit Off)</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>Launch Control</h3>
              <p>บริการทำ Launch Control / Anti-Lag</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
            <div className={styles.serviceCard}>
              <div className={`${styles.serviceIconPlaceholder} ${styles.small}`}></div>
              <h3>วัดแรงม้า (Dyno)</h3>
              <p>ทดสอบแรงม้าบนไดโน่เทส ก่อน/หลัง จูน</p>
              <a href="#" className={styles.readMore}>READ MORE</a>
            </div>
          </div>
        </section>
